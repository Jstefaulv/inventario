...
@RestController
@RequestMapping("personas")//buena práctica
...
public class PersonaRest implements UserDetailsService {
    ...
    public void guardar(Persona persona){
        ...
        Persona p = new Persona(persona.getNombre(),persona.getApepat(),persona.getApemat(),
                persona.getUsername(),encriptar,persona.getRut(),persona.getCargo(),persona.getRoles());
        personaDAO.save(p);
    }
